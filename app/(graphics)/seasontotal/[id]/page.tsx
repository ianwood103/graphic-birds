...
const MonthlyBirdTotalPage: NextPage<Props> = async ({
  ...
  return (
    <div
      className="w-[36rem] h-[36rem] bg-darkPrimary text-white flex flex-row justify-center relative"
      id="seasontotal"
    >
      <div className="flex flex-row w-10/12 h-full bg-darkPrimary bg-opacity-65 z-20">
        <div className="flex flex-col items-center w-full h-full relative">
          ...
          <span className="font-montserrat text-[34px] font-[700] leading-tight text-center w-10/12 -mt-[10px]">
